...
import MatchBuilder, {
  ...
  URI,
  opOptions
} from 'components/IstioWizards/RequestRouting/MatchBuilder';
import { isMatchesIncluded } from 'components/IstioWizards/RequestRouting';
...
class ExperimentTrafficForm extends React.Component<Props, TrafficState> {
  ...
  onAddRule = (rules: Rule[]) => {
    ...
    if (!isMatchesIncluded(rules, rule)) {
